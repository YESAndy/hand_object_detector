...
def inference(im, _checksession=1, _checkepoch=8, _checkpoint=132028):
  ...
  load_name = os.path.join(model_dir, 'faster_rcnn_{}_{}_{}.pth'.format(_checksession, _checkepoch, _checkpoint))
